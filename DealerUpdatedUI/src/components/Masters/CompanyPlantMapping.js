                ...
                <div className="card-body text-sm ">
                  ...
                  <div className='row'>
                    <div className="form-group col-md-3">
                      <label className='labelStyle' for="usercompanyNameInput" >Select Comany Name<sup style={{ color: "red" }}>*</sup></label>
                      <select
                    ...
                    <div className="form-group col-md-6">
                      <label className='labelStyle' >Select Plant Name<sup style={{ color: "red" }}>*</sup></label>
                      {/* <select
