                ...
                <div className="row text-left">
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column">
                      <label className="text-muted fw-medium">Total Amount:</label>
                      <span className="fw-bold text-success">15,51,089.00 ₹</span>
                    </div>
                  </div>
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column">
                      <label className="text-muted fw-medium">Total Tax:</label>
                      <span className="fw-bold text-primary">19,645.00 ₹</span>
                    </div>
                  </div>
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column">
                      <label className="text-muted fw-medium">Grand Total:</label>
                      <span className="fw-bold" style={{ color: "#8e44ad" }}>40,645.00 ₹</span>
                    </div>
                  </div>
                </div>
          ...
          <div className='row'>
            <div className='col-md-12 mb-4'>
              {isLoaderActive ? <PleaseWaitButton className='float-right btn-xs ml-2 font-weight-medium auth-form-btn' /> :
                <button type="submit" className="btn btn-primary float-right btn-xs ml-2 pl-5 pr-5" onClick={handleApproveModel}>Approve</button>
              }
              <button type="submit" className="btn btn-default float-right btn-xs pl-5 pr-5" onClick={handleRejectModal}>Reject</button>
            </div>
          </div>
        </div>
      </section>
        ...
        >
          <div className='modal-dialog modal-lg' role='document'>
            <div className='modal-content'>
              ...
              <div className='modal-body pl-5 pr-5 text-center '>
                 <i className="fas fa-info-circle fa-2x text-blue pb-3"></i>
            ...
            <div className='modal-content'>
              ...
              <div className='modal-body pl-5 pr-5 text-center '>
                ...
                {/* <i class="fas fa-check-circle"></i> */}
                 <i className="fas fa-check-circle fa-3x text-success pb-3"></i>
                <h5 className='modal-title w-100 text-center' style={{ color: "#343A40" }}>
                  Success
                </h5>
              </div>
              <div className='modal-body'>
                <p className='text-center'>
                 Sales Order no: 122345256  <br />approved with ITEOS Order No 1000000345
                </p>
              </div>
              <div className='d-flex justify-content-center pb-4'>
                {/* <button
