        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-8">
              <h1 className="m-0">Tracking Report</h1>
            ...
            <div className="col-sm-4">
              {/* <input
                ...
                placeholder="Search By Inovice No,Sales Order No..."
          ...
          <div className='row'>
            <div className="col-md-12">
              <div className="card  collapsed-card">
                <div className="filter-container   ml-1 p-4">
                ...
                <div className="card-header">
                  <div className='row'>
                    <div className='col-md-6'>
                      <h4 className="m-0">Tracking Report ( {allUsersList.length} )</h4>
                    </div>
                    <div className='col-md-6 d-flex justify-content-end'>
                      <input
                        ...
                        onChange={(e) => { }}
                      />
                       <div className='card-tools justify-content-end d-flex'>
