            ...
            <section className="content">
                <div className="container-fluid">
                  ...
                  <div className="card-tools">
                                ...
                                <div className="card-body text-sm" >
                                    ...
                                    <div className='row ml-1'>
                                        ...
                                        <div className="form-group  col-md-4">
                                            <label for="userEmailInput" style={{ color: "#6C757D" }}>Email<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label for="userNameInput" style={{ color: "#6C757D" }}>User Name<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label for="firstNameInput" style={{ color: "#6C757D" }}>First Name<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label  for="lastNameInput" style={{ color: "#6C757D" }}>Last Name<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group  col-md-4">
                                            <label className='labelStyle' for="contactNumberInput" style={{ color: "#6C757D" }}>Contact Number<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        {/* <div className="form-group col-md-4">
                      <label className='labelStyle' for="passwordInput" style={{ color: "#000" }}>Password<sup style={{ color: "red" }}>*</sup></label>
                    ...
                    <div className="form-group col-md-4">
                      <label className='labelStyle' for="passwordInput" style={{ color: "#000" }}>Confirm Password<sup style={{ color: "red" }}>*</sup></label>
                      ...
                      <span toggle="#passwordInput1" class="fa fa-fw fa-eye-slash field-icon-password toggle-password"></span>
                                        ...
                                        <div className="form-group col-md-4 position-relative">
                                            <label className='labelStyle' htmlFor="passwordInput1" style={{ color: "#6C757D" }}>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label className='labelStyle' style={{ color: "#6C757D" }}>Select Role<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label className='labelStyle' style={{ color: "#6C757D" }}>Select Company<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label className='labelStyle' style={{ color: "#6C757D" }}>Select Plant<sup style={{ color: "red" }}>*</sup></label>
                                        ...
                                        <div className="form-group col-md-4">
                                            <label className='labelStyle' style={{ color: "#6C757D" }}>Date Of Birth</label>
                                        ...
                                        <div className="form-group  col-md-8">
                                            <label className='labelStyle' for="addressInput" style={{ color: "#6C757D" }}>Address</label>
                                        ...
                                        <div class="form-group col-md-5">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <label className='labelStyle' class="custom-control-label" for="customSwitch1" style={{ color: "#6C757D" }}>User Can Access This Account?</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="card-footer text-sm">
                                    {isLoaderActive ? <PleaseWaitButton className='float-right btn-xs ml-2 font-weight-medium auth-form-btn' /> :
                                        <button type="submit" className="btn btn-primary float-right btn-xs ml-2" onClick={(e) => { handleUserSubmit(e) }}>Create</button>
                                    }
