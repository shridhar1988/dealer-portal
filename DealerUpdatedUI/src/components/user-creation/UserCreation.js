        ...
        <div className="container-fluid">
          <div className="row mb-2">
            ...
            <div className="col-sm-6 justify-content-end d-flex"> 
               <button type="button" className="btn  btn-sm btn-primary mr-2" id='AddNewHeaderButton' onClick={addNewUser} >
                      Add User
                    </button>
            </div>
          </div>
                          ...
                          return (
                            <tr style={{ textDecoration: userObj.isActive == true ? 'none' : 'line-through' }}>
                              ...
                              <td style={{ fontWeight: '400', fontSize: 'smaller' }} className='text-center text-sm'>
                                <button type="button" class="btn bg-gradient-primary btn-xs" onClick={(e) => { handleEditTaskDetails(userObj) }} style={{ padding: '5px', fontSize: '.75rem', lineHeight: '0', borderRadius: '50%' }}>
