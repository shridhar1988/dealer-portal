        ...
        <div className="row mb-2">
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center">
              <h1 className="m-0 pt-2 ml-1 mb-2" style={{ fontSize: "1.5rem" }}>
                Return Order
              </h1>
            </div>
          </div>
            ...
            <div className="">
              <div className="card ">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <h4 className="ml-4 mb-0">Total Orders (8)</h4>
               ...
               style={{border :"none",outline: "none"}}></i> */}
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        class="bi bi-x-circle mr-1 mb-1"
                        viewBox="0 0 16 16"
                      >
                    ...
                    <div
                      className="d-flex align-items-center gap-2 mt-1 mr-2 filter-box"
                      style={{ height: "34px" }}
                    >
                ...
                <div className="table-responsive mt-0 px-4">
