        ...
        <div className="row mb-2">
          <div className="col-12 mt-2 mb-2">
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <h1 className="m-0 pt-1 ml-1" style={{ fontSize: "1.5rem" }}>
            ...
            <div className="">
              <div className="card ">
               ...
               style={{border :"none",outline: "none"}}></i> */}
                    ...
                    <div className="d-flex align-items-center gap-2 mt-2  filter-box"  style={{height:"35px",marginRight:"32px"}}>
                ...
                <div
                  ...
                  style={{ height: "400px", overflowY: "auto",marginTop:"-9px" }}
                >
