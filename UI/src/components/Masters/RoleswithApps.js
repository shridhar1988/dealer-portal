...
const RoleswithApps = () => {
  ...
  const handleRoleSubmit = (e) => {
    ...
    if(roleName) {
      ...
      toast.error('Please enter role name.', config.tostar_config);
  ...
  const cteateAttachmentHTML = (appArray) => {
    ...
    if(appArray.length > 0) {
      return appArray.map((appID, index) => {
        ...
        return (<small className="badge badge-primary p-1 mt-1 ml-1"> {getEmaployeeName.appName}</small>)
      })
    }
              ...
              {isLoader && (
                ...
                <div className="card-header">
                  <h3 className="card-title text-sm"><i className='fas fa-arrow-left mr-2' style={{ cursor: 'pointer' }}
                    onClick={() => navigate('/masters')} /> Create New Role<span
                ...
                <div className="card-body text-sm ">
                  ...
                  <div className='row'>
                    <div className="form-group col-md-3">
                      <label for="userRoleNameInput" style={{ color: "#000" }}>Role Name<sup style={{ color: "red" }}>*</sup></label>
                    ...
                    <div className="form-group col-md-6">
                      <label style={{ color: "#000" }}>Select Apps<sup style={{ color: "red" }}>*</sup></label>
                      <select
