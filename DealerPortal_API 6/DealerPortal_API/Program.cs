...
builder.Services.AddScoped<IRetailerUserCreationServices, RetailerUserCreationServices>();
builder.Services.AddScoped<RequisitionServices, RetailUserService>();
...
{
    FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), "ProfileUploads")),
    RequestPath = "/ProfileUploads"
});
