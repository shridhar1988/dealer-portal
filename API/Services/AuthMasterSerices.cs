...
namespace Ticketing_API.Services
{
    public class AuthMasterSerices
    {
        ...
        public AuthMasterSerices(IConfiguration configuration, DealerPortalContext dbContext, EmailService emailService)
        {
        ...
        public async Task<UserWithRole> CreateUser(UserWithRole userWithRole)
        {
            try
            {
                ...
                User user = new User
                {
                    ...
                    FirstName=userWithRole.FirstName,LastName=userWithRole.LastName,ConfirmPassword=Encrypt
                    (userWithRole.Password, true),Role=userWithRole.RoleID.ToString(),Company=userWithRole.Company,
                    Plant= userWithRole.Plant,
