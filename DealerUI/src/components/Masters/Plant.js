...
const Plant = () => {
  ...
  const exportToCSV = () => {
    let csvContent = "Plant Code,Plant Description\n";
    filteredApps.forEach((app) => {
      csvContent += `${app.plantCode},${app.plantDescription}\n`;
    });
  ...
  const exportToPDF = () => {
    ...
    autoTable(doc, {
      head: [["Plant Code", "Plant Description"]],
      body: filteredApps.map((app) => [app.plantCode, app.plantDescription]),
    });
  ...
  const printTable = () => {
    ...
    printWindow.document.write("<table border='1' cellspacing='0' cellpadding='5'><thead><tr><th>Plant Code</th><th>Plant Description</th></tr></thead><tbody>");
    filteredApps.forEach((app) => {
      printWindow.document.write(`<tr><td>${app.plantCode}</td><td>${app.plantDescription}</td></tr>`);
    });
            ...
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0">Manage Plant
                  <span
                    hover-tooltip='In this you can manage the Plant which are accessed based on the role by giving the Plant Code and Plant Description. You create a new, edit and delete the Plant Info.'
              ...
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title text-sm"><i className='fas fa-arrow-left mr-2' style={{ cursor: 'pointer' }}
                    ...
                    <span
                      hover-tooltip='In this you can create a new and edit the Plant by giving the Plant Code and Plant Description.'
                      tooltip-position="bottom"
                    >
                      <i
                ...
                <div className='card-body text-sm'>
                  <div className='row'>
                    <div className="form-group col-md-3">
                      ...
                      Plant Code<sup style={{ color: 'red' }}>*</sup>
                      </label>
                      <input
                        type='text'
