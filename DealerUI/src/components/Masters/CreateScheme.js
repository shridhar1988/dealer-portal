                  ...
                  <div className="card-body text-sm">
                    <div className="container mt-0">
                      {/* <form className="row g-3">
                        ...
                        <div className="col-md-6 d-flex align-items-center p-2">
                          <label htmlFor="fileUpload" className="me-2 fw-bold mb-0 labelStyle" style={{ width: "200px" }}>
                            File:
                          </label>
                      ...
                      <div className='row'>
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="referanceId" style={{ color: "#000", width: "200px" }}>Reference ID:<sup style={{ color: "red" }}>*</sup></label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="validFrom" style={{ color: "#000", width: "200px" }}>Valid From:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="validTo" style={{ color: "#000", width: "200px" }}>Valid To:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="creationDate" style={{ color: "#000", width: "200px" }}>Creation Date:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="schemeType" style={{ color: "#000", width: "200px" }}>Type:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label className='labelStyle' for="createdBy" style={{ color: "#000", width: "200px" }}>Created By:</label>
