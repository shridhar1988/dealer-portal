...
import ilogo1 from "../../assets/images/DealerPortal_Login_logo.svg";
          ...
          switch (responseData.userRole) {
            ...
            case "Dealer":
             ...
             // window.location.reload();
              break;
            case "Approver":
              navigate("/sales-order-approval", { replace: true });
             // window.location.reload();
              break;
              case "Sales":
              navigate("/retailer-user-management", { replace: true });
             // window.location.reload();
              break;
            default:
  ...
  <div className="row">
    ...
    <div className="pl-0 mt-4">
      <div className="carousel slide">
        <div className="page1 carousel-inner px-5 py-2  "
        style={{border:"5px solid blue",borderRadius:"5px",height:"575px" }} >
          {images.map((image, index) => (
            ...
            >
              ...
              <img
                ...
                // className="img-fluid"
                alt={`slide-${index}`}
                style={{height:"350px",marginTop:"90px"}}
              />
