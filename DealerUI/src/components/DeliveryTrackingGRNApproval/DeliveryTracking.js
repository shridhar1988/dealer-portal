                ...
                <div className="card-header">
                  <div className='row'>
                    <div className='col-md-8'>
                      <h4 className="m-0">Track Delivery</h4>
                    </div>
          ...
          <div className="modal-dialog modal-sm  card card-outline card-primary ">
            <div className="modal-content " style={{ border: "none" }}>
              ...
              <div className="modal-body text-center " style={{ border: "none" }}>
                <p className="text-left" style={{ fontSize: "15px", color: "#333" }}>
                  Please Enter Remarks
                </p>
                <textarea
                  className={`form-control form-control-sm`}
              ...
              <div className="modal-footer justify-content-end" style={{ border: "none" }}>
                {isLoaderActive ? (
                  <PleaseWaitButton className="btn btn-warning btn-sm ml-2" />
                ) : (
                  <button
        ...
        <div className="modal fade show d-block" tabIndex="-1" style={{ backgroundColor: "rgba(0,0,0,0.5)", paddingTop: "100px" }}>
          <div className="modal-dialog modal-sm  card card-outline card-primary ">
            <div className="modal-content " style={{ border: "none" }}>
              ...
              <div className="modal-body text-center " style={{ border: "none" }}>
                <i className="fas fa-info-circle fa-2x text-black"></i>
                <h5 className="text-black">Information</h5>
                <p className="" style={{ color: "gray" }}>Do you want to upload POD?</p>
              </div>
          ...
          <div className="modal-dialog modal-sm  card card-outline card-primary ">
            <div className="modal-content " style={{ border: "none" }}>
              ...
              <div className="modal-body text-center " style={{ border: "none" }}>
                ...
                <h5 className="text-black">Success</h5>
                <p className="" style={{ color: "gray" }}> GRN Accepted successfully.!</p>
              </div>
              <div className="modal-footer justify-content-center" style={{ border: "none" }}>
                <button
                  type='button'
