                    ...
                    <div className="container mt-0">
                      <div className='row'>
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="material" style={{ color: "#000", width: "200px" }}>Material:<sup style={{ color: "red" }}>*</sup></label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="plant" style={{ color: "#000", width: "200px" }}>Plant:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="sloc" style={{ color: "#000", width: "200px" }}>Sloc:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="batch" style={{ color: "#000", width: "200px" }}>Batch:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="bun" style={{ color: "#000", width: "200px" }}>Bun:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="unrestricted" style={{ color: "#000", width: "200px" }}>Unrestricted:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="qualityInspection" style={{ color: "#000", width: "200px" }}>Quality Inspection:</label>
                        ...
                        <div className="form-group  col-md-6 d-flex align-items-center p-2">
                          <label for="valueUnrestricted" style={{ color: "#000", width: "200px" }}>Value Unrestricted:</label>
