...
debugger;
  ...
  const exportToCSV = () => {
    let csvContent = "Company Name,Company Description\n";
    filteredApps.forEach((app) => {
      csvContent += `${app.companyName},${app.companyDescription}\n`;
    });
  ...
  const exportToPDF = () => {
    ...
    autoTable(doc, {
      head: [["Company Name", "Company Description"]],
      body: filteredApps.map((app) => [app.companyName, app.companyDescription]),
    });
  ...
  const printTable = () => {
    ...
    printWindow.document.write("<table border='1' cellspacing='0' cellpadding='5'><thead><tr><th>Company Name</th><th>Company Description</th></tr></thead><tbody>");
    filteredApps.forEach((app) => {
      printWindow.document.write(`<tr><td>${app.companyName}</td><td>${app.companyDescription}</td></tr>`);
    });
            ...
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0">Manage Company
                  <span
                    hover-tooltip='In this you can manage the sidebar tabs which are accessed based on the role by giving the Company name and Company Description. You create a new, edit and delete the Company Info.'
              ...
              <div className="card card-outline card-primary">
                <div className="card-header">
                  <h3 className="card-title text-sm"><i className='fas fa-arrow-left mr-2' style={{ cursor: 'pointer' }}
                    ...
                    <span
                      hover-tooltip='In this you can create a new and edit the Company by giving the Company name and Company Description.'
                      tooltip-position="bottom"
                    >
                      <i
                  ...
                  <table class="table table-bordered table-sm table-striped">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style={{ fontWeight: '500', fontSize: 'smaller' }}>Company Name</th>
                    ...
                    <tbody>
                      {currentRows.map((roleObj, index) => (
                        <tr key={roleObj.appID}>
                          ...
                          <td style={{ fontWeight: '400', fontSize: 'smaller' }}>{roleObj.companyName}</td>
