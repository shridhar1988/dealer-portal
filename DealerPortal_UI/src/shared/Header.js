  ...
  return (
    <>
      <div className="wrapper">
        <nav class="main-header navbar navbar-expand  navbar-light text-sm bg-lightblue-heder">
          <ul class="navbar-nav" >
            <li class="nav-item">
              <a class="nav-link navbar-black" data-widget="pushmenu" href="#" role="button">
                <i class="fas fa-bars" style={{color:"rgb(139 134 134)"}}></i>
              </a>
            </li>
          </ul>
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown show">
              <a className="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
                <i className="fas fa-comments"style={{color:"rgb(139 134 134)"}}></i>
              </a>
            ...
            <li className="nav-item dropdown show">
              <a
                className="nav-link navbar-black"
                data-toggle="dropdown"
                href="#"
                aria-expanded="true"
              >
                <i className="fas fa-cog" style={{color:"rgb(139 134 134)"}}></i>
              </a>
              <div
